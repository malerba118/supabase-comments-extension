...
alter table "public"."sce_comment_reactions" add constraint "sce_comment_reactions_pkey" PRIMARY KEY using index "sce_comment_reactions_pkey";

alter table "public"."sce_comments" add constraint "sce_comments_pkey" PRIMARY KEY using index "sce_comments_pkey";

alter table "public"."sce_reactions" add constraint "sce_reactions_pkey" PRIMARY KEY using index "sce_reactions_pkey";

alter table "public"."sce_comment_reactions" add constraint "sce_comment_reactions_comment_id_fkey" FOREIGN KEY (comment_id) REFERENCES sce_comments(id) ON DELETE CASCADE;

alter table "public"."sce_comment_reactions" add constraint "sce_comment_reactions_reaction_type_fkey" FOREIGN KEY (reaction_type) REFERENCES sce_reactions(type);

alter table "public"."sce_comment_reactions" add constraint "sce_comment_reactions_user_id_comment_id_reaction_type_key" UNIQUE using index "sce_comment_reactions_user_id_comment_id_reaction_type_key";

alter table "public"."sce_comment_reactions" add constraint "sce_comment_reactions_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;

alter table "public"."sce_comments" add constraint "sce_comments_parent_id_fkey" FOREIGN KEY (parent_id) REFERENCES sce_comments(id) ON DELETE CASCADE;

alter table "public"."sce_comments" add constraint "sce_comments_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;

create or replace view "public"."sce_comment_reactions_metadata" as  SELECT sce_comment_reactions.comment_id,
...
create or replace view "public"."sce_comments_with_metadata" as  SELECT sce_comments.id,
...
create or replace view "public"."sce_display_users" as  SELECT users.id,
